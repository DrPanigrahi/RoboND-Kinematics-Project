...
[video01]: ./output/Kuka_Robotic_Arm_Project_Video_4p2.mov
...
## Software Installation, Dependencies, and Environment Setup
...
### ROS Installation Steps for Ubuntu
...
### Create ROS Workspace and Compile ROS Package
...
#### Transform from URDF to DH Coordinate frame
...
#### Evaluate theta_1, theta_2 and theta_3
...
#### Evaluate rotation matrices R3_0 and R3_6
...
#### Evaluate theta_4, theta_5 and theta_6
...
### Optimization of Grasping Parameters
